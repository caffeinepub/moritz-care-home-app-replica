...
import { useUpdateMedication, useGetResident } from '../../../hooks/useQueries';
...
export default function EditMedicationModal({ residentId, medication, onClose }: EditMedicationModalProps) {
  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold">Edit Medication</DialogTitle>
        ...
        <DialogFooter className="gap-2">
          ...
          <Button type="submit" onClick={handleSubmit} disabled={updateMedication.isPending} className="bg-blue-600 hover:bg-blue-700">

  ...
  const query = useQuery<UserProfile | null>({
    ...
    queryFn: async () => {
      ...
      try {
        ...
        console.log(
          "[Profile Query] Profile fetched:",
          profile ? "exists" : "null (new user)",
        );
        return profile;
      } catch (error: any) {
        console.error(
          "[Profile Query] Failed to fetch profile:",
          error.message,
        );
        throw error;
      }
...
export function useGetResident(residentId: ResidentId | undefined) {
  ...
  return useQuery<Resident | null>({
    ...
    queryFn: async () => {
      if (!actor || !residentId)
        throw new Error("Actor or resident ID not available");
...
export function useUpdateResident() {
  ...
  return useMutation({
    mutationFn: async ({
      residentId,
      updatedData,
    }: { residentId: ResidentId; updatedData: Resident }) => {
      if (!actor) throw new Error("Actor not available");
    ...
    onSuccess: (_, variables) => {
      ...
      queryClient.invalidateQueries({
        queryKey: ["resident", variables.residentId.toString()],
      });
...
export function useAddMedication() {
  ...
  return useMutation({
    mutationFn: async ({
      residentId,
      medicationData,
    }: { residentId: ResidentId; medicationData: Medication }) => {
      if (!actor) throw new Error("Actor not available");
      return actor.addMedication(residentId, medicationData);
    },
    onSuccess: (_, variables) => {
      queryClient.invalidateQueries({
        queryKey: ["medications", variables.residentId.toString()],
      });
      queryClient.invalidateQueries({
        queryKey: ["resident", variables.residentId.toString()],
      });
...
export function useDiscontinueMedication() {
  ...
  return useMutation({
    mutationFn: async ({
      residentId,
      medicationId,
    }: { residentId: ResidentId; medicationId: bigint }) => {
      if (!actor) throw new Error("Actor not available");
...
export function useAddMARRecord() {
  ...
  return useMutation({
    ...
    onSuccess: (_, variables) => {
      queryClient.invalidateQueries({
        queryKey: ["marRecords", variables.residentId.toString()],
      });
      queryClient.invalidateQueries({
        queryKey: ["resident", variables.residentId.toString()],
      });
...
export function useAddADLRecord() {
  ...
  return useMutation({
    ...
    onSuccess: (_, variables) => {
      queryClient.invalidateQueries({
        queryKey: ["adlRecords", variables.residentId.toString()],
      });
      queryClient.invalidateQueries({
        queryKey: ["resident", variables.residentId.toString()],
      });
...
export function useAddDailyVitals() {
  ...
  return useMutation({
    ...
    onSuccess: (_, variables) => {
      queryClient.invalidateQueries({
        queryKey: ["dailyVitals", variables.residentId.toString()],
      });
      queryClient.invalidateQueries({
        queryKey: ["resident", variables.residentId.toString()],
      });
...
export function useAddResponsibleContact() {
  ...
  return useMutation({
    mutationFn: async ({
      residentId,
      contact,
    }: { residentId: ResidentId; contact: ResponsibleContact }) => {
      if (!actor) throw new Error("Actor not available");
...
export function useUpdateResponsibleContact() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      residentId: ResidentId;
      contactId: bigint;
      updatedContact: ResponsibleContact;
    }) => {
      if (!actor) throw new Error("Actor not available");
      return actor.updateResponsibleContact(
        residentId,
        contactId,
        updatedContact,
      );
...
export function useAddPharmacyInfo() {
  ...
  return useMutation({
    mutationFn: async ({
      residentId,
      pharmacy,
    }: { residentId: ResidentId; pharmacy: PharmacyInfo }) => {
      if (!actor) throw new Error("Actor not available");
...
export function useAddInsuranceInfo() {
  ...
  return useMutation({
    mutationFn: async ({
      residentId,
      insurance,
    }: { residentId: ResidentId; insurance: InsuranceInfo }) => {
      if (!actor) throw new Error("Actor not available");
...
export function useUpdateInsuranceInfo() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (!actor) throw new Error("Actor not available");
      return actor.updateInsuranceInfo(
        residentId,
        insuranceId,
        updatedInsurance,
      );
...
export function useAddPhysician() {
  ...
  return useMutation({
    mutationFn: async ({
      residentId,
      physician,
    }: { residentId: ResidentId; physician: Physician }) => {
      if (!actor) throw new Error("Actor not available");
